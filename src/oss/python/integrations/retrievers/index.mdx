...
|-----------|---------|---------|
| [`ApifySearchRetriever`](/oss/integrations/retrievers/apify_search) | Internet search via the [Apify RAG Web Browser](https://apify.com/apify/rag-web-browser) | [`langchain-apify`](https://pypi.org/project/langchain-apify/) |
...
<Card title="Apify Search" icon="link" href="/oss/integrations/retrievers/apify_search" arrow="true" cta="View guide" />
